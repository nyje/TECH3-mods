-- mostly taken from the digtron mod

-- Copyright (C) 2017 FaceDeer, licensed under MIT license
...
feedlotFakePlayer = {}
feedlotFakePlayer.__index = feedlotFakePlayer
...
function feedlotFakePlayer.update(self, pos, player_name)
...
function feedlotFakePlayer.create(pos, player_name)
	local self = {}
	setmetatable(self, feedlotFakePlayer)
